...
// Define the types of commands your app will use.
...
class ChatProtocol: NWProtocolFramerImplementation {
    ...
    // Create a global definition of your chat protocol to add to connections.
    ...
    static var label: String { return "TCP_Connection" }
